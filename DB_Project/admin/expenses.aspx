<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expenses.aspx.cs" Inherits="DB_Project.admin.expenses" %>
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <h3>Enter the Match Expenses details</h3>
    </div>

    <div class=" mt-4 container-fluid" action="">

        <div class="mb-3">
            <label for="exampleInputName" class="form-label">Select the name of the Cricket Match</label>
            <br>
            <select class="dropdown2 ">
                <option value="">PAK VS SA</option>
                <option value="">IND VS AUS</option>
                <option value="">Opposition1 VS Opposition2</option>
        ...
        <div class="mb-3">
            <label for="secuirtyCost" class="form-label">Enter the secuirty costs of the match</label>
            <div style="display: flex;"> 
             <span ><pre>  PKR </pre></span>
                <input type="number" class="form-control" id="secuirtyCost" aria-describedby="emailHelp" >
            </div>
        </div>
        <div class="mb-3">
            <label for="foodCost" class="form-label">Enter the Food costs in the match</label>
            <div style="display: flex;"> 
             <span ><pre>  PKR </pre></span>
                <input type="" class="form-control" id="foodCost" aria-describedby="emailHelp" >
            </div>
        </div>
        <div class="mb-3">
            <label for="labourCost" class="form-label">Enter the labour costs of the stadium</label>
            <div style="display: flex;"> 
             <span ><pre>  PKR </pre></span>
                <input type="text" class="form-control" id="labourCost" aria-describedby="emailHelp" >
            </div>
        </div>
        <div class="mb-3">
            <label for="labourCost" class="form-label">The total costs of the match is:</label>
            <div style="display: flex;"> 
             <span ><pre>  PKR </pre></span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Do you want to save the match expenses in the database
                        </h5>

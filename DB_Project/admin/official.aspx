<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="official.aspx.cs" Inherits="DB_Project.admin.official" %>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="official.aspx">Cricket Board Official</a>
                    </li>
                    <li class="nav-item">
                ...
                <asp:TextBox ID="TextBox1" runat="server" Width="247px" class="form-control me-2" placeholder="Search officials"
                        aria-label="Search" >
    ...
    <div class="container-fluid mt-4">
        ...
        <h3>Enter the Cricket Board Official details</h3>

    </div>
    <div class=" mt-4 container-fluid" >
         
        <div class="mb-3">
            <label for="CBOName" class="form-label">Enter the first name of the Cricket Board Official</label>
            <asp:TextBox runat="server" ID="CBOName" Text="" class="form-control"></asp:TextBox>

            <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
        </div>
        <div class="mb-3">
            <label for="CBOName" class="form-label">Enter the  last name of the Cricket Board Official</label>
            <asp:TextBox runat="server" ID="CBOLName" Text="" class="form-control"></asp:TextBox>

            <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
        </div>
        <div class="mb-3">
            <label for="CBOQualification" class="form-label">Qualification</label>
            <asp:TextBox runat="server" ID="CBOQualification" Text="" class="form-control"></asp:TextBox>

            <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
        </div>
        <div class="mb-3">
            <label for="experienceyrs" class="form-label">Years of Experience</label>
            <asp:TextBox runat="server" ID="experienceyrs" Text="" class="form-control"></asp:TextBox>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Do you want to save the Cricket Board Official in
                            the database</h5>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="officialDetail.aspx.cs" Inherits="DB_Project.admin.officialDetail" %>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="stadium.html">Stadium</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="enclosure.html">Enclosures</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="official.html">Cricket Board Official</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid mt-4">
        <h3>Cricket Board Official Details</h3>
    ...
    <div class="container-fluid mt-4">
        <table id="customers">
            <tr>
                <th>Match Official Name</th>
                <td>Javed Miandad Enclosure</td>
            </tr>
            <tr>
                <th>Qualification</th>
                <td>Masters in Sports</td>
            </tr>
            <tr>
                <th>Experience</th>
                <td>5 years</td>

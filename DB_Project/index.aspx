<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DB_Project.index" %>
        ...
        <div class="rca-logo">
          <h2>
            ...
            <div style="display: flex;justify-content: center;text-align: center;">
              <span>
                <div class="dropdown">
                  <a href="choose.aspx"> <i class="fas fa-user"></i></a>
              </span>
  ...
  <div class="rca-row">
    ...
    <div class="rca-column-4">
      ...
      <div class="rca-menu-widget rca-live-season rca-left-border">
        <a href="matchDetail.html" class="rca-padding">
          <span class="rca-match-title rca-live-text">IND vs IRE : </span><span class="rca-match-score">Ind 89/8 -
            14.8(0)</span>
    ...
    <div class="rca-column-4">
      ...
      <div class="rca-menu-widget rca-left-border">
        <a href="matchDetail.html" class="rca-padding">
          <span class="rca-match-title">IND vs IRE : </span><span class="rca-match-score">Sun, 31 Jan 2:10 pm
            IST</span>
        </a>
      </div>
    </div>
  ...
  <div class="rca-row">
    <div class="rca-column-12">
      <div class="rca-blog-image">
        <h2>Cricket Board Management System</h2>
      </div>
    </div>
  </div>
  <div class="rca-row">
    ...
    <div class="rca-column-5">
      ...
      <div class="rca-medium-widget rca-blog-content">
        ...
        <div class="rca-padding">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam tincidunt tortor, nec rutrum nibh
          posuere nec. Aenean sodales justo vel mauris volutpat finibus. Mauris cursus ultricies leo ac vestibulum.
          Duis molestie faucibus enim, nec tristique mi.<br /><br /> Integer tellus ipsum, tincidunt a dictum sit
          amet, congue eget arcu. Proin ut dolor at dui auctor egestas. In hac habitasse platea dictumst. Pellentesque
          quam nisl.
        </div>
      </div>
      ...
      <div class="rca-mini-widget rca-top-border rca-tab-simple">
        ...
        <div id="ltab-2" class="rca-padding rca-tab-content">
          <div class="rca-match-detail rca-padding">
            <h3 class="rca-match-title">
              <a href="matchDetail.html">BAN vs ZIM</a>
        ...
        <div id="rtab-1" class="rca-padding rca-tab-content active">
          <div class="rca-column-4">
            <div class="rca-blog-content">
              ...
              <div class="rca-padding">
                Curabitur blandit bibendum massa a vestibulum. Pellentesque habitant morbi tristique senectus et netus
                et malesuada fames ac turpis egestas. Class aptent taciti sociosqu...
              </div>
            </div>
          </div>
          <div class="rca-column-4">
            <div class="rca-blog-content">
              ...
              <div class="rca-padding">
                Litora torquent per conubia nostra, per inceptos himenaeos. Aenean eleifend non augue eu euismod. Sed
                tempus justo eu aliquam vestibulum. Sed sit amet metus mollis.
              </div>
            </div>
          </div>
          <div class="rca-column-4">
            <div class="rca-blog-content">
              ...
              <div class="rca-padding">
                Donec mattis velit sed placerat dictum. Phasellus eget quam odio. Mauris non magna elit. In neque
                arcu, auctor in tristique at, molestie quis mauris. Nullam suscipit sed nulla.
              </div>
            </div>
          </div>

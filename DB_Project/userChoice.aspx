<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userChoice.aspx.cs" Inherits="DB_Project.userChoice" %>
...
<body>
    ...
    <div class="container">
        <a href="normalUserLogin.aspx">
            <button class="btn transparent" id="sign-up-btn">
                Normal User
            </button>
        </a>
        <a href="smsSubscriberLogin.aspx">
            <button class="btn transparent" id="Button1" style="padding: 4px;">
                SMS Subscriber
            </button>
        </a>
    </div>
